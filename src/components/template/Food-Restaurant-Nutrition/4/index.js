import '../../../../styles/Food-Restaurant-Nutrition/template4.scss'
import 'bootstrap/dist/css/bootstrap.css';

function FoodRestaurantNutritionTemplate4() {
    return (
        <div id="div-FoodRestaurantNutrition4-container">
            ...
            <div id="ligne" className="d-flex flex-row align-items-center justify-content-center">
                <div className="d-flex flex-row align-items-center justify-content-center">
                    ...
                    <div className="div-texte">
                        ...
                        <p className="texte">Sample text, consectetur adipiscing.</p>
            ...
            <div id="ligne" className="d-flex flex-row align-items-center justify-content-center">
                ...
                <div className="d-flex flex-row align-items-center justify-content-center">
                    ...
                    <div className="div-texte">
                        ...
                        <p className="texte">Made with 100% whole grain flour and high in fiber.</p>
                        <div className="prix">$​5.15</div>
                    </div>  <img src="https://images01.nicepagecdn.com/c461c07a441a5d220e8feb1a/8d95eb12993a55918f0eac4e/trrt.jpg" />
                </div>
            </div>

            <a href="https://nicepage.com/html-templates/preview/handmade-bread-3265292?device=desktop">Lien</a>
        </div>
    );
}
