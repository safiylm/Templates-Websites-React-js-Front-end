...
function ArticleRecette({imageurl, titre}) {
    ...
    return (
        <div id="div-un-article" className="d-flex flex-row justify-content-center align-items-start">
            <img id="image-article" src={imageurl} />
           
            <div id="div-un-article-texte" className="d-flex flex-column justify-content-between">
                <div id="div-personna" className="d-flex flex-row align-items-center justify-content-start">
                ...
                <div id="div-commentaire-like" className="d-flex flex-row align-items-center justify-content-between">
